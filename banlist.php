...
if ($_GET['deleted'] == 1) {
$message = '<div class="alert alert-block alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><i class="ace-icon fa fa-check green"></i> Baneo eliminado correctamente.</div>';
}
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Housekeeping - Manejar Baneos</title>
		...
		?>
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Manejar Baneos</li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								<i class="ace-icon fa fa-angle-double-right"></i> Manejar Baneos
								<small>
									<br>
									Edita y revisa las expulsiones del Hotel. Puedes desbanear usuarios eliminando el campo.
								</small>
							</h1>
						</div><!-- /.page-header -->
