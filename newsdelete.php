					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="active">
								<a href="news.php">
									<i class="menu-icon fa fa-caret-right"></i>
									Modifica o Elimina  una noticia
								</a>
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Noticias
								<small>
									<i class="ace-icon fa fa-newspaper"></i>
									Lista de noticias - Modifica o elimina
								</small>
							</h1>
						</div><!-- /.page-header -->
										...
										<table id="simple-table" class="table table-striped table-bordered table-hover">
											...
											?>
												...
												<td><?php echo $news_q['id']; ?></td>
													...
													<td>
													<form method="post">
															<center><button formaction="newsedit.php?id=<?php echo $news_q['id']; ?>" class="boton botonazul">
																<i class="iconogrande menu-icon fa fa-pencil-alt"></i>
															</button><br>

															<button name="delete_<?php echo $news_q['id']; ?>" style="margin-top:4px;"class="boton botonrojo">
