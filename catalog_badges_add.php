...
if (isset($_POST['check'])) {
    ...
    $existe=1;
	$message = '<div class="alert alert-block alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><i class="ace-icon fa fa-check green"></i> La placa existe como imagen, puedes agregarla a la tienda.</div>';
	}else{
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Housekeeping - Agregar Placa a la Tienda</title>
		...
		?>
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
							<a href="catalog_badges.php">Tienda de Placas</a>
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								<i class="ace-icon fa fa-angle-double-right"></i> Agregar Placa<br>
								<small>
									Pon en venta una nueva placa en la tienda de Hebbo Hotel. Recuerda actualizar la tienda al finalizar.
								</small>
							</h1>
						</div><!-- /.page-header -->
...
<div class="row">
                                    ...
                                    <div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="badgecode"> Código de Placa: </label>
										<div class="col-sm-9">
									...
									?>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="credits"> Valor de Créditos: </label>
										<div class="col-sm-9">
